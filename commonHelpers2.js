          ...
          <a href="${a}">
            ...
            <div class="img-desc">
              ...
              <span><b>Downloads:</b> <br/>${p}</span>
                  ...
                  `).join("");f.insertAdjacentHTML("afterbegin",r),l.style.display="none",i.q="",S.refresh(),c.reset()}function d(o){h.show({position:"topRight",iconUrl:g,message:o,backgroundColor:"#EF4040",messageColor:"#FAFAFB",messageSize:"16px",close:!1,closeOnClick:!0,closeOnEscape:!0})}
